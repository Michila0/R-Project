...
#data read
data <- read_excel("C:/Users/ASUS/Desktop/ML/vehicles.xlsx")
...
boxplot(clean_data)
#scaling
dim(clean_data) #return the column and row number
...
#Elbow method
fviz_nbclust(scaled_df, kmeans, method = 'wss') + geom_vline(xintercept = 3,linetype = 2) + labs(subtitle = "Elbow Method")
#Gap Static method
...
fviz_nbclust(PCA_dataset_reduced, kmeans, method = 'wss')+ geom_vline(xintercept = 3,linetype = 2) + labs(subtitle = "Elbow Method")
